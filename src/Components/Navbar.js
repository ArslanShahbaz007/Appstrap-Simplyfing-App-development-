...
function Navbar() {
  ...
  return (
    <div>
      <nav>
        <NavLink to='/' style={{display:'flex', alignItems:'center',margin:'4px'}}><SiConvertio color='white' size={38}  /><p style={{marginLeft:'10px', fontSize:'1.1rem', fontWeight:'600'}}>Video To Audio Converter</p></NavLink>
