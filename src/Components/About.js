            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-base md:text-lg">
                  ...
                  solution for seamlessly converting videos to audio files.
                  Our platform offers a hassle-free experience, supporting all
                  video formats for conversion into high-quality audio files.
                  With a user-friendly interface and powerful conversion
                  technology, we ensure that your video-to-audio conversion
              ...
              <div className="mb-8">
                ...
                <p className="text-base md:text-lg">
                  ...
                  free to convert an unlimited number of videos to your heart's
              ...
              <div className="mb-8">
                ...
                <p className="text-base md:text-lg">
                  You can utilize Video to Audio Converter Web-app from any device connected to the
